  ...
  return (
    <>
      ...
      >
        ...
        {/* Tooltip */}
        <motion.div
          className="absolute right-full mr-3 top-1/2 transform -translate-y-1/2 bg-gray-900 text-white text-sm px-3 py-2 rounded-lg whitespace-nowrap"
        ...
        <motion.button
          ...
          className="relative w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-green-600 hover:bg-green-700 shadow-lg hover:shadow-2xl transition-all duration-300 flex items-center justify-center group"
          style={{
