            ...
            <div className="grid md:grid-cols-2 gap-8 text-left">
              <div className="space-y-6">
                <div className="space-y-3">
                  <h3 className="text-xl font-semibold text-foreground">You Make More Money</h3>
                ...
                <div className="space-y-3">
                  <h3 className="text-xl font-semibold text-foreground">Better Customers Pay More</h3>
                  <p className="text-muted-foreground">
                ...
                <div className="space-y-3">
                  <h3 className="text-xl font-semibold text-foreground">Beat Your Competition</h3>
                  <p className="text-muted-foreground">
